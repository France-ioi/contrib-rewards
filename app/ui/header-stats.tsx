      ...
      <div className="flex flex-col md:flex-row gap-6 md:gap-12 items-center">
        ...
        <div className="basis-1/2 max-w-[500px] w-full">
          <div className="rounded-full bg-actions-hover relative h-[50px] md:h-[70px]">
            <div className="z-[1] shadow-progress rounded-full h-full relative bg-gradient-to-r from-[#AF2BAF] to-[#0F61FF]" style={{width: Math.round(targetPercentage) + '%'}}>
              <div className="text-white text-2xl absolute left-4 md:left-6 top-0 bottom-0 flex items-center font-bold text-[27px] md:text-[34px]">
                {config.currency}
              </div>
              <div className="text-white text-2xl absolute right-4 top-0 bottom-0 flex items-center font-bold text-[27px] md:text-[34px]">
                {donationStats.amount}
              </div>
            </div>

            <div className="text-white text-2xl absolute right-4 md:right-6 opacity-30 top-0 bottom-0 flex items-center font-bold text-[27px] md:text-[34px]">
          ...
          <div className="mt-6 flex gap-3 md:gap-5 items-center px-6">
            ...
            <div className="grow h-[8px] rounded-full bg-[#1A5DF9]">
              <div className="h-full rounded-full bg-[#E01AFF]" style={{width: Math.round(periodData.periodPercentage * 100) + '%'}}>
              </div>
            </div>
